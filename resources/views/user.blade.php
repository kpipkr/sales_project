                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <?php $no = 1 ?>
                                <table width="100%" class="table table-striped" id="example" class="display responsive nowrap">
                                    <thead>
                                        <tr>
                                            <th><center>No.</center></th>
                                            <th><center>Nama Perusahaan</center></th>
                                            <!-- <th><center>Alamat</center></th> -->
                                            <th class="priority-5"><center>Contact Person</center></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="priority-5"><center>{{ $customer->contact_no_perusahaan }}</center></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
